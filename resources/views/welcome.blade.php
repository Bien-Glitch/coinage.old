            ...
            <section class="row px-5">
                <div class="col-lg-5 col-md-12 col-sm-12 col-12">
                    <div class="d-flex justify-content-center justify-content-lg-start">
                        <img src="./design/img/buy~sell.svg" class="img-fluid" alt="" style="height: auto; width:90%;">
                    </div>
                </div>
            ...
            <section class="row">
                <div class="col-12 border-bottom bg-light py-4">
                    <div class="container d-flex flex-column text-uppercase py-4">
                        ...
                        <div class="row hiw mt-4">
                            <div class="col-lg-3 col-sm-6 mb-3 col-6">
                                <div class="d-flex flex-column align-items-center">
                                    <img src="./design/img/create~acc.svg" class="img-fluid" alt="" style="height: auto; width:70%; border-radius:30px;">
                                    <div class="font-weight-bolder"><span class="text-purple">create</span> an account</div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-sm-6 mb-3 col-6">
                                <div class="d-flex flex-column align-items-center">
                                    <img src="./design/img/choose~buy~sell.svg" class="img-fluid" alt="" style="height: auto; width:70%; border-radius:30px;">
                                    <div class="font-weight-bolder"><span class="text-purple">choose</span> buy or sell</div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-sm-6 mb-3 col-6">
                                <div class="d-flex flex-column align-items-center">
                                    <img src="./design/img/search~offers.svg" class="img-fluid" alt="" style="height: auto; width:70%; border-radius:30px;">
                                    <div class="font-weight-bolder"><span class="text-purple">search</span> for offers</div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-sm-6 mb-3 col-6">
                                <div class="d-flex flex-column align-items-center">
                                    <img src="./design/img/negotiate~close~deal.svg" class="img-fluid" alt="" style="height: auto; width:70%; border-radius:30px;">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-6 payment-method mb-4">
                                    <div class="d-flex flex-md-column flex-lg-row align-items-center p-3">
                                        <div class="d-flex justify-content-end" style="width: 25%"><img src="./design/img/mastercard.svg" alt=""></div>
                                        <span class="d-flex flex-fill justify-content-center text-purple ml-lg-2">Mastercard</span>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 payment-method mb-4">
                                    <div class="d-flex flex-md-column flex-lg-row align-items-center p-3">
                                        <div class="d-flex justify-content-end" style="width: 25%"><img src="./design/img/bank~transfer.svg" alt=""></div>
                                        <span class="d-flex flex-fill justify-content-center text-purple ml-lg-2">Bank Transfer</span>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 payment-method mb-4">
                                    <div class="d-flex flex-md-column flex-lg-row align-items-center p-3">
                                        <div class="d-flex justify-content-end" style="width: 25%"><img src="./design/img/visa.svg" alt=""></div>
                                        <span class="d-flex flex-fill justify-content-center text-purple ml-lg-2">Visa</span>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 payment-method mb-4">
                                    <div class="d-flex flex-md-column flex-lg-row align-items-center p-3">
                                        <div class="d-flex justify-content-end" style="width: 25%"><img src="./design/img/mobile~transfer.svg" alt=""></div>
                                        <span class="d-flex flex-fill justify-content-center text-purple ml-lg-2">POS</span>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 payment-method mb-4">
                                    <div class="d-flex flex-md-column flex-lg-row align-items-center p-3">
                                        <div class="d-flex justify-content-end" style="width: 25%"><img src="./design/img/ussd.svg" alt=""></div>
                                        <span class="d-flex flex-fill justify-content-center text-purple ml-lg-2">USSD</span>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 payment-method mb-4">
                                    <div class="d-flex flex-md-column flex-lg-row align-items-center p-3">
                                        <div class="d-flex justify-content-end" style="width: 25%"><img src="./design/img/qr~code.svg" alt=""></div>
                                        <span class="d-flex flex-fill justify-content-center text-purple ml-lg-2">QR Code</span>
                                    </div>
                                </div>
                            </div>
                            <div class="text-center py-4"><a href="" class="btn btn-purple text-uppercase" style="border:none;">View all offers</a></div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-4 mb-3">
                                <div class="testimonial-card">
                                    <img src="./design/img/gabe.png" alt="" style="width:60px; border-radius:50%;">
                                    <p class="text-purple mt-2">Gabriel Ibenye<br>
                                    <span class="txt-sm text-dark">CEO, Co-founder Bloodzone Technologies</span>
                                    </p>
                                    <p class="txt-sm" style="margin-top:-2%;">Coinage is a leading peer-to-peer crypto trading platform where you can safely trade with millions of users, using multiple payment methods</p>
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                <div class="testimonial-card">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 mb-4">
                                <div class="d-flex flex-column justify-content-center align-items-center">
                                    <div class="mb-3 row"><img src="./design/img/check.svg" class="mx-auto" alt="" style="width:50%;"></div>
                ...
                <div class="col-12 p-0">
                    ...
                    <div class="d-flex flex-column justify-content-around align-items-center position-relative" style="height: 300px">
                        ...
                        <a href="" class="btn btn-purple" style="border:none;">CREATE ACCOUNT</a>
                    </div>
                </div>
            </section>
        </div>
