                            ...
                            <div class="card-inner">
                                <div class="nk-wg7">
                                    <div class="nk-wg7-stats">
                                        <div class="nk-wg7-title">Available balance in NGN <span class="badge badge-primary">Beta</span></div>
                                        <div class="number-lg amount">179,850.950</div>
                                    </div>
                                    <div class="nk-wg7-stats-group">
                                        <div class="nk-wg7-stats w-50">
                                            <a href="pending-requests.html"><div class="nk-wg7-title"><u>Pending Requests</u></div></a>
                                            <div class="number-lg">5</div>
                                        </div>
                                        <div class="nk-wg7-stats w-50">
                                            <a href="transaction.html"><div class="nk-wg7-title mb-2"><u>Total Transactions</u></div></a>
            ...
            <div class="col-lg-7 col-xl-8">
                <div class="nk-block">
                    <div class="nk-block-head-xs">
                        <div class="nk-block-between-md g-2">
                            ...
                            <div class="nk-block-head-content">
                                <a href="wallets.html" class="link link-primary">See All</a>
                            </div>
                        </div>
                    </div><!-- .nk-block-head -->
                    <div class="row g-2">
                        <div class="col-sm-4">
                            <div class="card bg-light">
                                <div class="nk-wgw sm">
                                    <a class="nk-wgw-inner" href="wallet-bitcoin.html">
                                        <div class="nk-wgw-name">
                                            <div class="nk-wgw-icon">
                                                <em class="icon ni ni-sign-btc"></em>
                                            </div>
                                            <h5 class="nk-wgw-title title">Litecoing Wallet</h5>
                                        </div>
                                        <div class="nk-wgw-balance">
                                            <div class="amount text-sm">LhyLNfBkoKshT...</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="card bg-light">
                                <div class="nk-wgw sm">
                                    <a class="nk-wgw-inner" href="wallet-bitcoin.html">
                                        ...
                                        <div class="nk-wgw-balance">
                                            <div class="amount">3FZbgi29cpjq...</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="card card-bordered dashed h-100">
                                <div class="nk-wgw-add">
                                    <div class="nk-wgw-inner">
                                        <a type="button" data-toggle="modal" data-target="#modalAddBank">
                                            <div class="add-icon">
                ...
                <div class="nk-block nk-block-md">
                    <div class="nk-block-head-xs">
                        <div class="nk-block-between-md g-2">
                            <div class="nk-block-head-content">
                                <h6 class="nk-block-title title">Bank Accounts</h6>
                            </div>
                            <div class="nk-block-head-content">
                                <a href="wallets.html" class="link link-primary">See All</a>
                            </div>
                                ...
                                <div class="nk-wgw sm">
                                    <a class="nk-wgw-inner" href="wallet-bitcoin.html">
                                        <div class="nk-wgw-name">
                                            ...
                                            <h5 class="nk-wgw-title title">GTBank</h5>
                                        </div>
                                        <div class="nk-wgw-balance">
                                            <div class="amount">0225644127<span class="currency currency-nio">NGN</span></div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="nk-wgw sm">
                                    <a class="nk-wgw-inner" href="wallet-bitcoin.html">
                                        <div class="nk-wgw-name">
                                            ...
                                            <h5 class="nk-wgw-title title">Access Bank</h5>
                                        </div>
                                        <div class="nk-wgw-balance">
                                            <div class="amount">0339483746<span class="currency currency-eth">NGN</span></div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                ...
                <div class="card-head">
                    ...
                    <div class="card-tools">
                        <ul class="card-tools-nav">
                            <li class="active"><a href="transaction.html">View All</a></li>
                        </ul>
                    </div>
                </div><!-- .card-head -->
                    ...
                    <div class="tranx-item">
                        ...
                        <div class="tranx-col">
                            <div class="tranx-amount">
                                ...
                                <div class="number-sm">3,980.93 <span class="currency currency-NGN">NGN</span></div>
                            </div>
                        </div>
                    </div><!-- .tranx-item -->
                    <div class="tranx-item">
                        ...
                        <div class="tranx-col">
                            <div class="tranx-amount">
                                ...
                                <div class="number-sm">1,176.34 <span class="currency currency-NGN">NGN</span></div>
                            </div>
                        </div>
                    </div><!-- .tranx-item -->
                    <div class="tranx-item">
