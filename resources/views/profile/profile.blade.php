                                ...
                                <div class="nk-data data-list">
                                    ...
                                    <div class="data-item" data-toggle="modal"
                                        ...
                                        <div class="data-col">
                                            ...
                                            <span class="data-value">{{$user->last_name}} {{ $user->other_names}}</span>
                                        </div>
                                ...
                                <div class="nk-data data-list">
                                    ...
                                    <div class="data-item">
                                        ...
                                        <div class="data-col data-col-end"><a href="#"
                                                data-toggle="modal" data-target="#profile-language"
                            ...
                            <div class="card-inner-group" data-simplebar>
                                <div class="card-inner">
                                    <div class="user-card">
                                        ...
                                        <div class="user-action">
                                            <div class="dropdown">
                                                <a class="btn btn-icon btn-trigger mr-n2"
                                ...
                                <div class="card-inner p-0">
                                    <ul class="link-list-menu">
                                        <li><a class="active"
                                                href="html/user-profile-regular.html"><em
                                        ...
                                        <li><a href="html/user-profile-setting.html"><em
                                                    ...
                                                    Settings</span></a></li>
                                        <li><a href="#"><em
                                                    class="icon ni ni-shield-star-fill"></em><span>Password
                                                    Change</span></a></li>
                                        <li><a href="#"><em
