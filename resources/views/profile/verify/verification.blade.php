...
<div class="card card-bodered">
    <div class="nk-kycfm">
        ...
        <div class="nk-kycfm-head">
            <a href="{{URL("profile/verify/phone")}}">
                <div class=""><img class="w-70 d-block d-sm-none"
                        src="../../../dashboard/images/email/kyc-{{$user->hasVerifiedPhone() ? 'success' : 'pending'}}.png"
                        alt="" srcset=""></div>
                {{-- Hidden on only sm --}}
                <div class=""><img class="w-40 	 d-none d-sm-block"
                        src="../../../dashboard/images/email/kyc-{{$user->hasVerifiedPhone() ? 'success' : 'pending'}}.png"
            ...
            <div class="nk-kycfm-title">
                ...
                <p class="sub-title">Your phone number still requires verifcation for your identification</p>
            </div>
        </div><!-- .nk-kycfm-head -->
